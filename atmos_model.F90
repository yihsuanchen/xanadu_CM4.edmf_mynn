...
!--- indices for one-based arrays
       ...
       call physics_driver_up ( is, ie, js, je, npz, &
                                ...
                                Surface_boundary%t_ref    (isw:iew,jsw:jew), &!yhc, surface air temperature
                                Surface_boundary%q_ref    (isw:iew,jsw:jew), &!yhc, surface air specific humidity
                                Surface_boundary%u_flux   (isw:iew,jsw:jew), &!yhc, zonal wind stress
                                Surface_boundary%v_flux   (isw:iew,jsw:jew), &!yhc, meridional wind stress
#endif
                                Physics_tendency%block(blk),  &
