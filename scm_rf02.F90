...
!------------------------------------
  ...
  elseif (trim(option_any_profiles) .eq. "MERRA2_DYCOMS_3hr_11Jul1030Z_RF02") then
...
!---------------------------
  ...
  elseif (trim(option_read_rf02_forc_any) .eq. "MERRA2_DYCOMS_3hr_11Jul1030Z_RF02") then
