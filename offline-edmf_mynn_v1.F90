...
!############################
!############################
  !character*20 :: input_profile = "SCM_am4p0_DCBL_C1_01"
  character*20 :: input_profile = "SCM_am4p0_BOMEX_01"
  ...
  integer, parameter :: ntp = 1
  integer, parameter :: nQke = 2 
  integer, parameter :: nSh3D = 3
  integer, parameter :: nel_pbl = 4 
  integer, parameter :: ncldfra_bl = 5
...
program test111
  ...
  real,    dimension(ni,nj,nfull) :: p_full, z_full, z_full_actual, uu, vv, tt, qq, thv, ww, ql, qi, omega
...
if (input_profile == "SCM_am4p0_BOMEX_01") then
  ...
  endif ! end if of SCM_am4p0_BOMEX_01  
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
if (input_profile == "SCM_am4p0_DCBL_C1_01") then
  ...
  endif ! end if of SCM_am4p0_DCBL_C1_01  
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
