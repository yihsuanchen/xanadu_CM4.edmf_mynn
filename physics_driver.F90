...
!#######################################################################
  subroutine compute_vert_adv_tend_offline (dts, temp, temp_vert_advec_scheme, tracer_vert_advec_scheme)
    ...
    real, dimension(nprof, size(temp,1),size(temp,2),size(temp,3)+1) :: &
      ...
      omega_h_np        !  vertical pressure velocity at half levels (Pa/s)
   ...
   101362.435000000,    101780.000000000/)
      omega_h_np (1, ii_write, jj_write, :) = (/0.000000000000000E+000,  0.000000000000000E+000, &
  ...
  1.572365337671026E-003,  0.000000000000000E+000/)
   ...
   290.290044380658/)
    ...
    elseif (input_profile .eq. 1) then
      ...
      omega_h_np (n, ii_write, jj_write, :) = (/5.5864159e-05,  4.1863739e-05,  6.9493122e-05,  2.1614606e-04,&
      ...
      omega_h_np (n, ii_write, jj_write, :) = (/-3.80701604e-05, -9.42479237e-05, -6.99302182e-05,  4.66579731e-05,&
      ...
      omega_h_np (n, ii_write, jj_write, :) = (/-1.5646929e-04, -3.5355880e-04, -4.8761873e-04, -6.1965146e-04,&
      ...
      omega_h_np (n, ii_write, jj_write, :) = (/4.7953494e-05, -3.6808473e-05,  3.5740519e-05,  1.9297475e-04,&
      ...
      omega_h_np (n, ii_write, jj_write, :) = (/-6.3231586e-05, -2.7610478e-04, -3.5218231e-04, -9.3256996e-05,&
      ...
      omega_h_np (n, ii_write, jj_write, :) = (/-0.00010322, -0.00038814, -0.00068608, -0.00061517, -0.00035002,&
       ...
       -0.03900209, -0.00514794,  0.03117283,  0.04580639,  0.05880513,&
        ...
        0.00226887, -0.00692206, -0.01313566, 0./)
